...
ActiveRecord::Schema.define(:version => 20120903062726) do
  ...
  create_table "accesses", :force => true do |t|
    ...
    t.index ["parent_id"], :name => "index_accesses_on_parent_id"
    t.foreign_key ["parent_id"], "accesses", ["id"], :on_update => :restrict, :on_delete => :restrict, :name => "accesses_ibfk_1"
  end
  ...
  create_table "question_counts", :force => true do |t|
