...
describe Panel::SubscriptionsController do
  ...
  # Panel::Subscription. As you add validations to Panel::Subscription, be sure to
  ...
  # Panel::SubscriptionsController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all panel_subscriptions as @panel_subscriptions" do
      subscription = Panel::Subscription.create! valid_attributes
      get :index, {}, valid_session
      assigns(:panel_subscriptions).should eq([subscription])
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested subscription" do
        subscription = Panel::Subscription.create! valid_attributes
        # Assuming there are no other panel_subscriptions in the database, this
        # specifies that the Panel::Subscription created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Panel::Subscription.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the panel_subscriptions list" do
      subscription = Panel::Subscription.create! valid_attributes
      delete :destroy, {:id => subscription.to_param}, valid_session
      response.should redirect_to(panel_subscriptions_url)
    end
  end
