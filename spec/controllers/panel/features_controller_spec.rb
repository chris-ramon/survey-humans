...
describe Panel::FeaturesController do
  ...
  # Panel::Feature. As you add validations to Panel::Feature, be sure to
  ...
  # Panel::FeaturesController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all panel_features as @panel_features" do
      feature = Panel::Feature.create! valid_attributes
      get :index, {}, valid_session
      assigns(:panel_features).should eq([feature])
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested feature" do
        feature = Panel::Feature.create! valid_attributes
        # Assuming there are no other panel_features in the database, this
        # specifies that the Panel::Feature created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Panel::Feature.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the panel_features list" do
      feature = Panel::Feature.create! valid_attributes
      delete :destroy, {:id => feature.to_param}, valid_session
      response.should redirect_to(panel_features_url)
    end
  end
